package com.thewangzl.clientresttemplate.oauth;
...
public class AuthorizationCodeTokenService {
	...
	public String getAuthorizationEndpoint() {
		...
		authParameters.put("redirect_uri", getEncodeUrl("http://localhost:9001/callback"));
		authParameters.put("scope", getEncodeUrl("read_userinfo"));
		
		return this.buildUrl(endpoint, authParameters);
	}
